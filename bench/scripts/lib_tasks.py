"""
SegwayBench Task Library

This module provides task loading and parsing functionality for the SegwayBench
benchmarking system. Extends PinchBench's Task/TaskLoader with Segway-specific
fields: api_safety_level, fixtures, and mock_responses.
"""
...
class Task:
    """Represents a single benchmark task with Segway-specific extensions."""
    ...
    def __init__(
        ...
        # Segway-specific fields
        api_safety_level: str = "read_only",
        ...
        # Segway-specific fields
        self.api_safety_level = api_safety_level
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            # Segway-specific fields
            'api_safety_level': self.api_safety_level,
...
class TaskLoader:
    ...
    def load_task(self, task_file: Path) -> Task:
        ...
        task = Task(
            ...
            # Segway-specific fields extracted from frontmatter
            api_safety_level=metadata.get('api_safety_level', 'read_only'),
            fixtures=metadata.get('fixtures', {}),
            mock_responses=metadata.get('mock_responses', {}),
        )
